...
var EmployeeTaskService = (function () {
    function EmployeeTaskService(window, channelConfig) {
        var _this = this;
        this.window = window;
     ...
     * error.
     */
    EmployeeTaskService.prototype.start = function () {
        var _this = this;
     ...
     * channel
     * */
    EmployeeTaskService.prototype.sub = function (channel) {
        var _this = this;
    ...
    EmployeeTaskService.prototype.publish = function (ev) {
...
//# sourceMappingURL=employee.task.service.js.map